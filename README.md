# Приложение для расчёта геометрической задачи для варианта №6

Приложение должно позволять по введённым координатам трёх вершин треугольника $(x_1, y_1)$, $(x_2, y_2)$ и $(x_3, y_3)$
вычислять координаты точки пересечения высот треугольника.
...
Под формой редактирования должно отображаться решение задачи: координаты точки пересечения высот треугольника.
